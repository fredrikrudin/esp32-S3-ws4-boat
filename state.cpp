...
volatile bool cmd_save_bl = false, cmd_save_web = false, cmd_save_feat = false;
...
void load_cfg() {
  ...
  /* feature bits, same positions as the caravan project: 0x01 RuuviTags, 0x20 SD log, 0x40 CSV */
  ...
  USBSerial.printf("Loaded: ssid='%s' city='%s' place='%s' lat=%.4f lon=%.4f ruuvi=%d victron=%d\n",
